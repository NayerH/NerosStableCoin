...
class Nft extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const instance = new web3.eth.Contract(NerosNFTCoin.abi, deployedNetwork && deployedNetwork.address,);
      ...
      console.log(deployedNetwork && deployedNetwork.address)
      const instance2 = new web3.eth.Contract(NerosNFT.abi, deployedNetwork2 && deployedNetwork2.address,);
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      try {
        ...
        console.log(deployedNetwork && deployedNetwork.address)
        const instance = new web3.eth.Contract(NerosNFT.abi, deployedNetwork && deployedNetwork.address,);
  ...
  onImageChange = event => {
    if (event.target.files && event.target.files[0]) {
      ...
      this.setState({image: URL.createObjectURL(img), imageData: img});
    }
  };
