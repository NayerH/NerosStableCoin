...
B(S,R);if(O){var ka={};Object.defineProperties(S,(ka[Symbol.hasInstance]=P(function(){throw Error("Cannot perform instanceof checks for MutableMessage");}),ka))};function la(a,b){var c=this.g,d=!0;d=void 0===d?!1:d;N(a);a.o||(a.o={});var h=b?b.i:b;a.o[c]=b;b=d;b=void 0===b?!1:b;N(a);c<a.j&&!b?a.i[c+a.g]=h:(a.l||(a.l=a.i[a.j+a.g]={}))[c]=h;return a}
